        ...
        <div class="contenedor-tablas">
            <div class="card">
              ...
              <div class="card-footer clearfix">
                <a href="javascript:void(0)" class="btn btn-sm btn-secondary float-right">Ver todas las reservas</a>
              </div>
              <!-- /.card-footer -->
            </div>
                <!-- USERS LIST -->
                <div class="card">
                  ...
                  <div class="card-footer text-center">
                    <a href="javascript:void(0)" class="btn btn-sm btn-secondary float-right">Ver todas las donaciones</a>
                  </div>
                  <!-- /.card-footer -->
                </div>
                <!--/.card -->
              ...
              <div class="card-body p-0">
                <div class="table-responsive">
                  <table class="table m-0">
                    ...
                    <tr>
                      <td><a href="pages/examples/invoice.html">Recolección</a></td>
                      <td>2021-10-18</td>
                      <td><span class="badge badge-warning">Voluntarios</span></td>
                    </tr>
                  <tr>
              ...
              <!-- /.card-body -->
              <div class="card-footer clearfix">
                <a href="javascript:void(0)" class="btn btn-sm btn-secondary float-right">Ver todas las actividades</a>
              </div>
              <!-- /.card-footer -->
            </div>
