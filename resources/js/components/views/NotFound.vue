...
<div class="error-container">
  <div class="animate-404">
    <svg id="cogs" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 225 184" xml:space="preserve">
...
<div class="error-desc">La pagina que buscas no existe. <br />Regrese a la página de inicio o cualquier página conocida.</div>
</div>
</template>
