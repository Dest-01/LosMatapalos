...
export default {
  ...
  methods: {
    ...
    cargar10(){
      if (this.$gate.isAdmin() || this.$gate.isUser()) {
        axios
          .get("/api/ReporteReservas/solo10")
    ...
    cargar25(){
      if (this.$gate.isAdmin() || this.$gate.isUser()) {
        axios
          .get("/api/ReporteReservas/solo25")
          .then(({ data }) => (this.filtroArray = data.data));
          this.exportPDF();
      }
    },
    cargar50(){
      if (this.$gate.isAdmin() || this.$gate.isUser()) {
        axios
          .get("/api/ReporteReservas/solo50")
          .then(({ data }) => (this.filtroArray = data.data));
           this.exportPDF();
      }
    },
    cargar75(){
      if (this.$gate.isAdmin() || this.$gate.isUser()) {
        axios
          .get("/api/ReporteReservas/solo75")
          .then(({ data }) => (this.filtroArray = data.data));
           this.exportPDF();
      }
    },
    cargar100(){
      if (this.$gate.isAdmin() || this.$gate.isUser()) {
        axios
          .get("/api/ReporteReservas/solo100")
          .then(({ data }) => (this.filtroArray = data.data));
           this.exportPDF();
      }
    }
