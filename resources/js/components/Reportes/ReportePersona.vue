  ...
  methods: {
    exportPDF() {
      ...
      var columns = [
        ...
        { title: "Primer Apellido", dataKey: "apellido1" },
        { title: "Segundo Apellido", dataKey: "apellido2" },
      ...
      doc.text(" Reporte de personas", 50, 68);
