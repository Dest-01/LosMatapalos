...
export default {
  ...
  methods: {
    exportPDF() {
      ...
      var columns = [
        { title: "Nombre Actividad", dataKey: "nombre" },
        { title: "Fecha Actividad", dataKey: "fecha" },
        { title: "Hora Actividad", dataKey: "hora" },
        { title: "Cantidad Participantes", dataKey: "cantParticipantes" },
        { title: "Tipo Actividad", dataKey: "tipo" },
      ...
      doc.text(" Reporte de actividades", 50, 68);
    ...
    async cargar() {
      if (this.$gate.isAdmin() || this.$gate.isUser()) {
        await axios
          .get("/api/ReporteActividades/todo")
