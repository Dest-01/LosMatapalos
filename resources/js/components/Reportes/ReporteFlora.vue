...
export default {
  ...
  methods: {
    exportPDF() {
      ...
      var columns = [
        { title: "Nombre Común", dataKey: "nom_comun" },
        { title: "Nombre Científico", dataKey: "nom_cientifico" },
        { title: "Descripción", dataKey: "descripcion" },
        { title: "Tipo Flora", dataKey: "tipo" },
        { title: "Familia Cientifica", dataKey: "fam_cientifica" },
        { title: "Fecha Registro", dataKey: "fecha_registro" },
      ];
      ...
      doc.text(" Reporte de flora", 50, 68);
      ...
      doc.save("Reporte Flora.pdf");
    },
    cargar() {
      if (this.$gate.isAdmin() || this.$gate.isUser()) {
        axios
          .get("/api/ReporteFlora/todo")
